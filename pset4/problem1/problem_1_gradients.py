...
def gradient(y: torch.Tensor, x: torch.Tensor) -> torch.Tensor:
    ...
    """
    # grad_outputs argument necessary for when y is multi-dimensional
    # create_graph argument necessary for computing gradients for SIREN as described above
